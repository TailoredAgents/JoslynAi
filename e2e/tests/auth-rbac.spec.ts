...
test("Viewer cannot send letters; owner can", async () => {
  ...
  const draft = await api.post("http://localhost:8080/tools/letter/draft", { data: { kind: "evaluation-request", merge_fields: { child_id: "demo-child", parent_name: "P", child_name: "C", school_name: "S", requested_areas: "Speech", todays_date: "2025-09-10", reply_by: "2025-09-20" } } });
